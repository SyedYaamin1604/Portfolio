  ...
  return (
    <>
      <div className='pt-14 pb-10'>
        <h1 className='text-blue-400 text-3xl text-center font-bold mt-14 mb-3 lg:text-5xl'>Contact With Me</h1>
        <div className='mx-10 flex flex-col items-center lg:flex-row lg:justify-between gap-5 xl:gap-16'>
          <div className='border-2 border-black w-full mt-5 rounded-xl px-8 bg-blue-950'>
            <p className='text-sky-300 font-base text-xl w-full mt-4'>If you have any questions or concerns, please don't hesitate to contact me. I am open to any work opportunities that align with my skills and interests.</p>
            <form className='text-sky-300'>
              <div className='mt-5'>
                <label className='text-3xl font-normal'>Your Name:</label><br />
                <input className='text-2xl text-blue-400 outline-none h-12 w-full rounded-xl bg-black border-2 border-blue-400 px-2 mt-2' type="text" /><br />
              </div>
              <div className='mt-3'>
                <label className='text-3xl font-normal'>Your Email:</label><br />
                <input className='text-2xl text-blue-400 outline-none h-12 w-full rounded-xl bg-black border-2 border-blue-400 px-2 mt-2' type="email" /><br />
              </div>
              <div className='mt-3'>
                <label className='text-3xl font-normal'>Your Message:</label><br />
                <textarea className='text-2xl text-blue-400 outline-none h-36 w-full rounded-xl bg-black border-2 border-blue-400 px-2 mt-2' id="textarea"></textarea><br />
              </div>
          ...
          <div className='mt-10 w-full'>
            <h1 className='text-xl text-white flex justify-start items-center gap-2 lg:text-3xl'>
            ...
            <h1 className='text-xl text-white flex justify-start items-center gap-2 mt-2 lg:mt-7 lg:text-3xl'>
              ...
              +92 3482300194</h1>
            <h1 className='text-xl text-white flex justify-start items-center gap-2 mt-2 lg:text-3xl lg:mt-7'>
            ...
            <div className='mt-4 text-2xl sm:text-3xl lg:text-4xl xl:text-5xl lg:mt-10 flex justify-start lg:justify-start items-center gap-6'>
