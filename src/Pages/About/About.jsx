...
const About = () => {
  return (
    <>
      <div className='flex flex-col lg:flex-row lg:justify-between px-4 lg:pt-20 lg:mx-12 xl:mx-28 items-center'>
        ...
        <div className='lg:mt-16'>
          ...
          <p className='text-white text-xs font-medium md:text-base lg:text-lg min-[450px]:w-[28rem] sm:w-[35rem] md:w-[36rem] xl:w-[38rem] text-center mt-3 lg:text-left'>Hi, I'm Syed Yaamin, a dedicated software engineer in web development. I have a passion for building dynamic, responsive, and user-friendly web applications using JavaScript, React, and Firebase. I enjoy solving problems and working on projects that challenge me to learn and grow.</p>
          <p className='text-white font-medium md:text-base lg:text-lg text-xs min-[450px]:w-[28rem] sm:w-[35rem] md:w-[36rem] xl:w-[38rem] text-center mt-3 lg:text-left'>I'm always looking for opportunities to improve my skills and stay current with new technologies in the field. My aim is to contribute to meaningful projects and make a positive impact in the development industry.</p>
        </div>
      </div>
      <div className='pb-20'>
        ...
        <div className='flex flex-wrap justify-center items-center gap-8 text-8xl text-blue-400 mt-10'>
