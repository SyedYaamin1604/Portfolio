...
const Projects = () => {
  ...
  return (
    <>
      <div className='lg:mx-28 mx-2 py-5 mt-5'>
        <div className='mt-20'>
          <h1 className='text-white text-xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-center'>My Recent <span className='text-blue-400'>Projects</span></h1>
          <p className='text-white font-normal text-sm md:text-xl text-center mt-3'>Here are a few Projects I've worked on recently.</p>
        </div>
      </div>
      <div className='py-5 pb-10 flex justify-center items-center flex-wrap gap-10'>
        <div className="card bg-blue-950 bg-opacity-80 mx-2 w-96 shadow-2xl shadow-blue-400 transition delay-100 duration-1000 ease-in-out hover:-translate-y-1 hover:scale-110 hover:bg-blue-600">
          ...
          <div className="card-body items-center text-center px-4">
            <h2 className="card-title text-white text-xl md:text-3xl font-bold">Portfolio</h2>
            <p className='text-white text-sm md:text-base'>A digital representation of my skills and projects as a developer. It features a modern design with animations to make browsing enjoyable.</p>
        ...
        <div className="card bg-blue-950 bg-opacity-80 mx-2 w-96 shadow-2xl shadow-blue-400 transition delay-100 duration-1000 ease-in-out hover:-translate-y-1 hover:scale-110 hover:bg-blue-600">
          ...
          <div className="card-body items-center text-center px-4">
            <h2 className="card-title text-white text-xl md:text-3xl font-bold">Buy-Sell Corner</h2>
            <p className='text-sm md:text-base text-white'>An e-commerce web app designed to simplify online buying and selling. It includes product listings, user authentication, and a sleek UI.</p>
            <div className="card-actions flex justify-center items-center gap-5">
        ...
        <div className="card bg-blue-950 bg-opacity-80 mx-2 w-96 shadow-2xl shadow-blue-400 transition delay-100 duration-1000 ease-in-out hover:-translate-y-1 hover:scale-110 hover:bg-blue-600">
          ...
          <div className="card-body items-center text-center px-4">
            <h2 className="card-title text-white text-xl md:text-3xl font-bold">Blogging Website</h2>
            <p className='text-sm md:text-base text-white'>A minimalist platform for sharing ideas and stories. It allows users to publish, edit, and manage blogs effortlessly.</p>
            <div className="card-actions flex justify-center items-center gap-5">
        ...
        <div className="card bg-blue-950 bg-opacity-80 mx-2 w-96 shadow-2xl shadow-blue-400 transition delay-100 duration-1000 ease-in-out hover:-translate-y-1 hover:scale-110 hover:bg-blue-600">
          ...
          <div className="card-body items-center text-center px-4">
            <h2 className="card-title text-white text-xl md:text-3xl font-bold">Weatherly</h2>
            <p className='text-sm md:text-base text-white'>A responsive weather app providing real-time weather updates, including temperature, humidity, and a 5-day forecast.</p>
            <div className="card-actions flex justify-center items-center gap-5">
